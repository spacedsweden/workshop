...
redirectFrom:
  - docs/phone-calls-with-android-contact-picker
---
In this tutorial, I will walk you through using the Android Contact Picker to let your users choose a phone number from their contact book. Upon finishing this tutorial, you can follow our [Android calling tutorials](call-a-phone-number-from-your-android-app-with-sinch.md) to make a call with Sinch.
...
I hope this gives a good example of how to use the Android Contact Picker. Next up, we will be using Sinch to make a phone call with that number. Head over to our [Android tutorial](call-a-phone-number-from-your-android-app-with-sinch.md).
