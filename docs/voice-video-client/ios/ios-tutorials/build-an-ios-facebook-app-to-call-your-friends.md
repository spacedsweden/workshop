...
In order to get all of the user’s friends with the app, we need to populate the UITableView in the master view controller when it's loaded. We can do this by calling a method in `viewDidLoad`. Add the following method to **MasterViewController.h**:
