...
description: >-
  In this tutorial, we’ll show how easy it's to build a regular conference
  calling solution with both Dial in & Dial out functionality.  Continue
  reading.
redirectFrom:
  - /docs/build-your-own-conference-calling-system-in-c
---
...
**In this tutorial, we’ll show how easy it's to build a regular conference calling solution with both Dial in and Dial out functionality. In part 2 and 3, we’ll add VoIP clients to the mix.**
...
public async Task<ActionResult> Details(int id) {
    ...
    {
        //don'thing, just means no one is in the conference
