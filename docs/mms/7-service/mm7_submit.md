...
description: Send a MMS message to end users trough the Sinch MM7 API. Read more.
redirectFrom:
  - /docs/mm7-service-mm7_submit
---
...
| StatusCode    | MT message submit accepted/rejected is based on Success/Failure status code. “Success” response doesn't mean the message was delivered to the handset. See all Status Codes: `mms_status_codes` |
